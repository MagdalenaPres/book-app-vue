        ...
        <tbody>
            <tr v-for="a in allAuthors" :key="a.id">
                ...
                <td>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" @click="deleteAuthor(a.id)"
  ...
  <div class="container p-5">
     ...
     <div class="add-authors"> 
        <form class="adding">
          ...
          <button id="add" type="submit" @click="addAuthor">Add author</button>
        </form>
      </div>
      <br>   
      <div class="update-authors"> 
        <form class="updating">
          ...
          <button id="update" type="submit" @click="updateAuthor">Update author</button>
        </form>
      </div>
</template>
